...
<table class="table">
  <thead>
    <tr><th width="15%">Topic</th><th width="15%">Subtopic</th><th width="40%">Readings</th><th>Presenter</th></tr></thead>
  <tbody>
    <tr><td>Introduction</td><td></td><td></td><td>Instructor</td></tr>
    <!-- section 1 -->
    ...
    </ul></td><td>Instructor + students</td></tr>
    ...
    </td><td>Instructor + students</td></tr>
    <!-- section 3 -->
